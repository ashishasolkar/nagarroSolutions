...
const SPFieldUserEdit: React.SFC<ISPFormFieldProps> = (props) => {
    ...
    if (props != null) {
        ...
        if (props.value != null && props.value != "") {
            principals = props.value.map((x: { EntityData: { Email: any; }; Key: string; }) => {
        ...
        if (props.fieldSchema['SharePointGroupName' as keyof typeof props.fieldSchema] != null) {
            groupName = props.fieldSchema['SharePointGroupName' as keyof typeof props.fieldSchema];
        }
    }
...
function getUpdatedValue(items: any[]): any[] {
